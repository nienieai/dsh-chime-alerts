        ...
        ctx.effect(() => server.register({
          ...
          handler: async (req, res) => {
            try {
              ...
              const data = await readJson(SETTINGS_FILE)
              let hostBeep = null
              if (data !== null && typeof data === 'object' && typeof data.hostBeep === 'boolean') hostBeep = data.hostBeep
              const cap = await hostBeepCapable()
              const body = JSON.stringify({ ok: getFs() !== null, hostBeep, dir: dirPath, platform: PLATFORM, capBeep: cap })
