// ============================================================
// dsh-chime-alerts · 客户端半（Client half）— v0.3.11
...
return {
  ...
  apply(ctx) {
    ...
    const PATTERNS = {
      complete: [[659.25, 0, 0.25, 'triangle'], [987.77, 0.2, 0.55, 'sine']],
      ...
      goalblocked: [[440, 0, 0.16, 'triangle'], [440, 0.2, 0.16, 'triangle'], [349.23, 0.4, 0.35, 'triangle']],
      interrupt: [[311.13, 0, 0.18, 'triangle'], [311.13, 0.24, 0.18, 'triangle']],
      jobfail: [[494, 0, 0.14, 'triangle'], [494, 0.18, 0.14, 'triangle'], [392, 0.36, 0.35, 'triangle']]
    }
    ...
    const SOUND_OPTIONS = [
      ...
      { value: 'goalblocked', label: T('受阻音 · 锯齿警报', 'Blocked · sawtooth alarm') },
      { value: 'interrupt', label: T('打断音 · 低频双响', 'Interrupt · low double beep') },
      { value: 'jobfail', label: T('失败音 · 短促双响', 'Failure · short double beep') },
